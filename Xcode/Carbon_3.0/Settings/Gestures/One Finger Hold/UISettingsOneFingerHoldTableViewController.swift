//
//  UISettingsTapAndHoldTableViewController.swift
//  Carbon_3.0
//
...
class UISettingsOneFingerHoldTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView,
        ...
        if indexPath.row == 0 {
            UserPreferences.oneFingerHold = indexPath.section + indexPath.row
            updateSelectedRow()
        } else {
