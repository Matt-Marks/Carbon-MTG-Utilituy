...
class CarbonProViewController: UIViewController {
    ...
    private let contentInset: UIEdgeInsets  = UIEdgeInsets(top: 80, left: 0, bottom: 160, right: 0)
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        CarbonProUtilities.helper.requestProducts{ [weak self] success, products in
    ...
    private func enableButtons() {
        ...
        let product     = products[CarbonProUtilities.CarbonPro]!
        let priceString = priceStringForProduct(product)
    ...
    private func priceStringForProduct(_ product: SKProduct) -> String? {
    ...
    @IBAction func purchaseButtonPressed(_ sender: UIButton) {
        CarbonProUtilities.helper.buyProduct(products[CarbonProUtilities.CarbonPro]!)
    }
    
    @IBAction func restoreButtonPressed(_ sender: UIButton) {
        CarbonProUtilities.helper.restorePurchases()
    }
...
extension CarbonProViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 3:
            ...
            cell.setBody("Become monarch.")
            cell.setStatus(.new)
        case 4:
            cell.setIcon(.grayscaleSkull)
            cell.setTitle("Kill Players")
            cell.setBody("Kill any player.")
            cell.setStatus(.new)
        case 5:
        ...
        case 6:
            ...
            cell.setBody("Instead of black text on a colored background, choose to have players with colored text on a black background.")
            cell.setStatus(.updated)
        case 7:
            cell.setIcon(.grayscaleApp)
            cell.setTitle("30 App Icons")
            cell.setBody("Choose an app icon tha exactly matches your theme and accent color.")
            cell.setStatus(.new)
        case 8:
